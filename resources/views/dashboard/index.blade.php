...
<div class="row">
    <div class="col-12">
        ...
        <div class="alert alert-info">
            ...
            Welcome back, {{ $organiser->name }}! Here's an overview of your events and their current status.
        </div>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">{{ count($eventsReport) }}</h5>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title" id="total-bookings">{{ array_sum(array_column($eventsReport, 'current_bookings')) }}</h5>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title" id="total-waitlist">{{ array_sum(array_column($eventsReport, 'waitlist_count')) }}</h5>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title" id="total-capacity">{{ array_sum(array_column($eventsReport, 'capacity')) }}</h5>
                                ...
                                @foreach($eventsReport as $event)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted">{{ \Carbon\Carbon::parse($event->time)->format('g:i A') }}</small>
                                        </td>
                                        <td>{{ $event->location }}</td>
                                        <td>{{ $event->capacity }}</td>
                                        <td>
                                            <span class="badge bg-primary">{{ $event->current_bookings }}</span>
                                        </td>
                                        <td>
                                            @if($event->remaining_spots == 0)
                                                <span class="badge bg-danger">Full</span>
                                            @elseif($event->remaining_spots <= $event->capacity * 0.2)
                                                <span class="badge bg-warning">{{ $event->remaining_spots }}</span>
                                            @else
                                                <span class="badge bg-success">{{ $event->remaining_spots }}</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if($event->waitlist_count > 0)
                                                <span class="badge bg-info">{{ $event->waitlist_count }}</span>
                                            @else
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                @if($event->waitlist_count > 0)
                                                    <a href="{{ route('dashboard.waitlist', $event->id) }}" 
