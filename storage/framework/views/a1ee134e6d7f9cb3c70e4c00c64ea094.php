...
<head>
    ...
    <title><?php echo e(config('app.name', 'Event Management System')); ?></title>
...
<body class="font-sans antialiased">
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('events.index')); ?>">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->isAttendee()): ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('bookings.waitlist')); ?>">
                                        <i class="fas fa-clock me-1"></i>My Waitlist
                                    </a>
                                </li>
                            <?php elseif(auth()->user()->isOrganiser()): ?>
                                <li class="nav-item">
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <span class="badge bg-secondary ms-1"><?php echo e(ucfirst(auth()->user()->user_type)); ?></span>
                                </a>
...
<?php /**PATH /Users/kaiphan/Assignment/resources/views/layouts/app.blade.php ENDPATH**/ ?>