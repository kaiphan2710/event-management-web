                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <h5 class="card-title"><?php echo e($entry->event->title); ?></h5>
                                    <span class="badge bg-warning">Position #<?php echo e($entry->position); ?></span>
                                </div>
                                
                                <p class="card-text text-muted"><?php echo e(Str::limit($entry->event->description, 100)); ?></p>
                                
                                <div class="mb-3">
                                    <div class="d-flex align-items-center mb-1">
                                        <i class="fas fa-calendar me-2"></i>
                                        <small class="text-muted"><?php echo e($entry->event->date->format('M d, Y')); ?></small>
                                    </div>
                                    <div class="d-flex align-items-center mb-1">
                                        <i class="fas fa-clock me-2"></i>
                                        <small class="text-muted"><?php echo e($entry->event->time); ?></small>
                                    </div>
                                    <div class="d-flex align-items-center mb-1">
                                        <i class="fas fa-map-marker-alt me-2"></i>
                                        <small class="text-muted"><?php echo e($entry->event->location); ?></small>
                                    </div>
                                    <div class="d-flex align-items-center mb-1">
                                        <i class="fas fa-user-tie me-2"></i>
                                        <small class="text-muted">Organiser: <?php echo e($entry->event->organiser->name); ?></small>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-hourglass-half me-2"></i>
                                        <small class="text-muted">Joined: <?php echo e($entry->joined_at->format('M d, Y g:i A')); ?></small>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">
                                        <?php echo e($entry->event->getCurrentBookings()); ?>/<?php echo e($entry->event->capacity); ?> booked
                                    </small>
                                </div>
                                ...
                                <?php else: ?>
                                    <div class="alert alert-info alert-sm">
                                        ...
                                        You're position <?php echo e($entry->position); ?> on the waitlist.
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="card-footer bg-transparent border-top">
                                <div class="d-flex justify-content-between">
                                    <a href="<?php echo e(route('events.show', $entry->event)); ?>" 
                                       class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-eye me-1"></i>View Event
                                    </a>
                                    <form method="POST" action="<?php echo e(route('events.leave-waitlist', $entry->event)); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/kaiphan/Assignment/resources/views/bookings/waitlist.blade.php ENDPATH**/ ?>